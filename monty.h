...
/**
 * struct global_variable - global variables used in Monty
 * @push_arg: argument for push opcode
 * @buffer: pointer to store data
 *
 * Description: global variables for stack operations
...
/* Function Prototypes for Monty Operations */
